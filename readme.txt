C++
Make all produce the "submission" executable.
Make run will execute the executable but it does not include the input file, output file, or specify the algorithm.
